...
#
# This is the PORTABLE entry point. Its computational body is a VERBATIM copy of
# examples/reproduce_chr19_GM12878.py (the manuscript driver): the same functions
# are called with the same arguments, in the same order, with the same seed
# (assign_read_alleles_ASE seed=2023) and the same toggles. The ONLY differences
# are:
...
#      (`from scvarsim import engine as scIsoSim`) instead of via sys.path hacks.
...
#
# Conda ENV: scIsoSim (see environment.yml)
import argparse
import os
...
def main():
    ...
    # ================================================================= #
    # Everything below this line is a VERBATIM copy of the driver's main #
    # body (examples/reproduce_chr19_GM12878.py). Do not edit -- editing #
    # here would diverge from the reproducibility record.                #
    # ================================================================= #
